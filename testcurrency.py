...
def test_get_src():
    ...
    introcs.assert_equals('2 United States Dollars', result,
                          'Did not meet test requirements.')
    result = currency.get_src('{"success":true, "src":"2 United States Dollars",'
                              ' "dst":"1.772814 Euros", "error":""}')
    introcs.assert_equals('2 United States Dollars', result,
                          'Did not meet test requirements.')
    ...
    result = currency.get_src('{"success": true,"src": "","dst": "","error":'
                              ' "Source currency code is invalid."}')
    introcs.assert_equals("", result, 'Did not meet test requirements.')
    result = currency.get_src('{"success": false, "src": "", "dst": "", "error": '
                              '"The rate for currency EUF is not present."}')
    introcs.assert_equals('', result, 'Did not meet test requirements')
...
def test_get_dst():
    ...
    result = currency.get_dst('{"success":false,"src":"","dst":"",'
                              '"error":"Source currency code is invalid."}')
    introcs.assert_equals("", result, 'Did not meet test requirements.')
    result = currency.get_dst('{"success": true,"src": "","dst": '
                              '"","error": "Source currency code is invalid."}')
    introcs.assert_equals("", result, 'Did not meet test requirements.')
    result = currency.get_dst('{"success": false, "src": "", "dst": "", '
                              '"error": "The rate for currency EUF is'
                              ' not present."}')
    introcs.assert_equals('', result, 'Did not meet test requirements')
...
def test_has_error():
    ...
    result = currency.has_error(
        '{"success": true, "src": "2 United States Dollars",'
        ' "dst": "1.772814 Euros", "error": ""}')
    ...
    result = currency.has_error('{"success": true,"src": "","dst": ""'
                                ',"error": "Source currency code is invalid."}')
    introcs.assert_true(result, 'Did not meet test requirements.')
